...
// This logic prevents overlapping or invalid appointment bookings.
    public int validateAppointment(Appointment appointment) {
        ...
        var doctorOptional = doctorRepository.findById(appointment.getDoctor().getId());
        ...
        for (String slot : availableSlots) {
            if (slot.contains(requestedTime) || requestedTime.contains(slot)) {
                return 1;
            }
        }
        return 0;
...
// This flexible method supports patient-specific querying and enhances user experience on the client side.
    public ResponseEntity<Map<String, Object>> filterPatient(String condition, String name, String token) {
        try {
            ...
            return patientService.getPatientAppointment(patient.getId(), token, "patient");
        } catch (Exception e) {
            Map<String, Object> err = new HashMap<>();
